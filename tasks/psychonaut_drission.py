...
def register(chromium, page, seq, extension_url='https://psy.xyz/psychonaut?icode=A8C7EBBB'):
...
def psychonaut_drission(metadata: dict):
    if len(metadata) < 10:
        return
    ...
    extension_url = f"https://psy.xyz/psychonaut?icode=A8C7EBBB"
