...
def snoonaut_drission(metadata: dict):
    if len(metadata) < 10:
        return
    ...
    extension_url = f"https://earn.snoonaut.xyz?ref=SNOOTAXQ6R7"
    ...
    try:
        ...
        if page.ele('text=Connect with Reddit',timeout=5):
            page.ele('x://button[@class="page_redditButton__8ZmHu"]').wait(1).click('js')
